...
public class JSONEventLayoutCEE extends Layout {
    ...
    public static final String ADDITIONAL_DATA_PROPERTY = "net.logstash.log4j.JSONEventLayoutCEE.UserFields";
     ...
     */
    public JSONEventLayoutCEE(boolean locationInfo) {
    ...
    public String format(LoggingEvent loggingEvent) {
        ...
        return "@cee: " + logstashEvent.toString() + "\n";
    }
